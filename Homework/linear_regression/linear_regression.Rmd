...
If we are building an R package instedad of just documenting a loose funciton, we should use `Roxygen2`. The major difference is the specific formatting, but it lets us automatically generate package documentaion!
